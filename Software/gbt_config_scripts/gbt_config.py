...
ch=int(sys.argv[1])
topbot_mode=int(sys.argv[2])
topbot_database=int(sys.argv[3])
timewait=0.1
...
if top_find==0:
    ...
    while phase_cnt !=0:
	    ...
	    phase_cnt=0
            ...
            if topbot_database==0:
                print "the topbot value from database can't be used"
else:
