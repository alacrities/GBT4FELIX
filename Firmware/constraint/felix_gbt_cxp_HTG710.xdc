...
### CXP1 CH5-CH8   <-->  GBT  CH5-CH8
set_property PACKAGE_PIN AU5 [get_ports  {RX_N[4]}]
set_property PACKAGE_PIN AV7 [get_ports  {RX_N[5]}]
set_property PACKAGE_PIN AP7 [get_ports  {RX_N[6]}]
set_property PACKAGE_PIN AR5 [get_ports  {RX_N[7]}]

create_pblock pblock_3
add_cells_to_pblock [get_pblocks pblock_3] [get_cells -quiet [list {g1.u2/gbtRxTx[4].gbtTxRx_inst} {g1.u2/gbtRxTx[5].gbtTxRx_inst}]]
add_cells_to_pblock [get_pblocks pblock_3] [get_cells -quiet [list {g1.u2/gbtRxTx[6].gbtTxRx_inst} {g1.u2/gbtRxTx[7].gbtTxRx_inst}]]
resize_pblock [get_pblocks pblock_3] -add {SLICE_X170Y100:SLICE_X221Y149}

### CXP1 CH9-CH12   <-->  GBT  CH9-CH12
set_property PACKAGE_PIN AN5 [get_ports  {RX_N[20]}]
set_property PACKAGE_PIN AL5 [get_ports  {RX_N[21]}]
set_property PACKAGE_PIN AM7 [get_ports {RX_N[22]}]
set_property PACKAGE_PIN AJ5 [get_ports {RX_N[23]}]

create_pblock pblock_1
add_cells_to_pblock [get_pblocks pblock_1] [get_cells -quiet [list  {g1.u2/gbtRxTx[20].gbtTxRx_inst} {g1.u2/gbtRxTx[21].gbtTxRx_inst}]]
add_cells_to_pblock [get_pblocks pblock_1] [get_cells -quiet [list  {g1.u2/gbtRxTx[22].gbtTxRx_inst} {g1.u2/gbtRxTx[23].gbtTxRx_inst}]]
resize_pblock [get_pblocks pblock_1] -add {SLICE_X170Y150:SLICE_X221Y199}

### CXP2 CH1-CH4  <-->  GBT  CH13-CH16
set_property PACKAGE_PIN L5  [get_ports {RX_N[8]}]
set_property PACKAGE_PIN P7  [get_ports {RX_N[9]}]
set_property PACKAGE_PIN J5  [get_ports {RX_N[10]}]
set_property PACKAGE_PIN N5  [get_ports {RX_N[11]}]

create_pblock pblock_6
add_cells_to_pblock [get_pblocks pblock_6] [get_cells -quiet [list {g1.u2/gbtRxTx[8].gbtTxRx_inst} {g1.u2/gbtRxTx[9].gbtTxRx_inst}]]
add_cells_to_pblock [get_pblocks pblock_6] [get_cells -quiet [list {g1.u2/gbtRxTx[10].gbtTxRx_inst} {g1.u2/gbtRxTx[11].gbtTxRx_inst}]]
resize_pblock [get_pblocks pblock_6] -add {SLICE_X170Y350:SLICE_X221Y399}



### CXP2 CH5-CH8  <-->  GBT  CH17-CH20
...
set_property PACKAGE_PIN D7  [get_ports {RX_N[16]}]
set_property PACKAGE_PIN B7  [get_ports {RX_N[17]}]
set_property PACKAGE_PIN C5  [get_ports {RX_N[18]}]
set_property PACKAGE_PIN A5  [get_ports {RX_N[19]}]

create_pblock pblock_4
add_cells_to_pblock [get_pblocks pblock_4] [get_cells -quiet [list {g1.u2/gbtRxTx[16].gbtTxRx_inst} {g1.u2/gbtRxTx[17].gbtTxRx_inst}]]
add_cells_to_pblock [get_pblocks pblock_4] [get_cells -quiet [list {g1.u2/gbtRxTx[18].gbtTxRx_inst} {g1.u2/gbtRxTx[19].gbtTxRx_inst}]]
